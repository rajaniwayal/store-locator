...
<html>
	...
	<body>
		<a href="#show-storeParent" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-storeParent" class="content scaffold-show" role="main">
			...
			<ol class="property-list storeParent">
				...
				<g:if test="${storeParentInstance?.countryName}">
				<li class="fieldcontain">
					<span id="countryName-label" class="property-label"><g:message code="storeParent.countryName.label" default="Country Name" /></span>
					
						<span class="property-value" aria-labelledby="countryName-label"><g:fieldValue bean="${storeParentInstance}" field="countryName"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${storeParentInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
